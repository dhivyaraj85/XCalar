...
for i in range(1, count+1):
    ...
    user_total_acc = fake.pyint()%(max_acc+1)
    ...
    if(user_total_acc <= total_acc):
        ...
        user_new_acc = fake.pyint()%(user_total_acc+1)
...
def connect():
 ...
 # execute a statement
        ...
        print(top_accounts)
        print(top_new_balances)	
        print(bottom_add_balances)
        ...
        #print(top_accounts_str+":"+top_new_balances_str)
